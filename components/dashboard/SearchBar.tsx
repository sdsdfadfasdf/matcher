  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full border border-[#3c3c3c] bg-[#1a1a1a] pl-9 pr-9 py-2 text-sm text-zinc-200 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#0066b1]/50"
      />
      {search && (
        <button
          onClick={() => setSearch("")}
